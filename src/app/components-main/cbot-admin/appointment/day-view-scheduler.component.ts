...
import { CalendarUtils, CalendarWeekViewComponent, CalendarEventTimesChangedEventType } from 'angular-calendar';
...
//     dayViewEvent => {
//                   let index;
//                   view.users.indexOf(dayViewEvent.event.meta.user);

//                   view.users.forEach((item, indexEv) => {
//                       if (item.id === dayViewEvent.event.meta.user) {
//                           index = indexEv;
//                           return;
//                       }
//                   });
